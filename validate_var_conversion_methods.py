...
def norm_bank(x: str) -> str:
    # Normalize bank names to a lowercase alphanumeric identifier.
...
def main():
    ...
    # row 1 contains bank names
    # row 2 contains confidence levels (0.95 / 0.99)
    # row 3 onward contains the observations
    ...
    # Extract the Bank of America series from the reconstructed table.
    # The date column is typically named "year_Level" in this layout.
    ...
    # Convert the relevant columns to their analysis types.
    ...
    # Keep only valid observations with positive VaR values.
    ...
    # Compute percentage errors relative to the observed VaR(99%).
    ...
    # Summarize fit using R-squared and RMSE.
    ...
    # Panel 2: Gaussian predictions against actual VaR(99%).
    ...
    # Panel 3: empirical-factor predictions against actual VaR(99%).
